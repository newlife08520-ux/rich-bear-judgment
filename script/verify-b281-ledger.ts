...
const pause = fs.readFileSync(path.join(r, "server", "modules", "execution", "handlers", "meta-campaign-pause-handler.ts"), "utf8");
if (!led.includes("campaign:") || !pause.includes("entityKeys")) process.exit(1);
