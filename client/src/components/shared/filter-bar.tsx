...
const SORT_OPTIONS: { value: SortKey; label: string }[] = [
  { value: "dormant_priority", label: "沉睡／復活分數優先" },
  { value: "revival_priority", label: "復活排序（revivalPriorityScore）" },
            ...
            <SelectContent>
              {SORT_OPTIONS.map((o) => (
                <SelectItem
                  key={o.value}
                  value={o.value}
                  data-testid={o.value === "dormant_priority" ? "sort-option-dormant-priority" : undefined}
                >
                  {o.label}
                </SelectItem>
              ))}
